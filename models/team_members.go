...
type TeamMember struct {
	TeamId string      `boil:"teamId" json:"teamId" toml:"teamId" yaml:"teamId"`
...
var TeamMemberWhere = struct {
	...
	TeamId: whereHelperstring{field: "\"team_members\".\"teamId\""},
	UserId: whereHelperstring{field: "\"team_members\".\"userId\""},
	Role:   whereHelpernull_String{field: "\"team_members\".\"role\""},
}
...
func (r *teamMemberR) GetTeamIdTeam() *Team {
	if r == nil {
		return nil
	}
	return r.TeamIdTeam
...
func (r *teamMemberR) GetUserIdUser() *User {
	if r == nil {
		return nil
	}
	return r.UserIdUser
...
var (
	teamMemberAllColumns            = []string{"teamId", "userId", "role"}
	teamMemberColumnsWithoutDefault = []string{"teamId", "userId"}
	teamMemberColumnsWithDefault    = []string{"role"}
	teamMemberPrimaryKeyColumns     = []string{"teamId", "userId"}
...
func (o *TeamMember) UserIdUser(mods ...qm.QueryMod) userQuery {
	queryMods := []qm.QueryMod{
...
// loaded structs of the objects. This is for an N-1 relationship.
func (teamMemberL) LoadUserIdUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTeamMember interface{}, mods queries.Applicator) error {
	var slice []*TeamMember
	var object *TeamMember
	...
	if singular {
		...
		foreign.R.UserIdTeamMembers = append(foreign.R.UserIdTeamMembers, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.UserId == foreign.ID {
				...
				foreign.R.UserIdTeamMembers = append(foreign.R.UserIdTeamMembers, local)
				break
			}
		}
	}
...
func (o *TeamMember) SetTeamIdTeam(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Team) error {
	...
	values := []interface{}{related.ID, o.TeamId, o.UserId}
...
// SetUserIdUser of the teamMember to the related item.
// Sets o.R.UserIdUser to related.
// Adds o to related.R.UserIdTeamMembers.
func (o *TeamMember) SetUserIdUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	if related.R == nil {
		related.R = &userR{
			UserIdTeamMembers: TeamMemberSlice{o},
		}
	} else {
		related.R.UserIdTeamMembers = append(related.R.UserIdTeamMembers, o)
	}
...
func FindTeamMember(ctx context.Context, exec boil.ContextExecutor, teamId string, userId string, selectCols ...string) (*TeamMember, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"team_members\" where \"teamId\"=$1 AND \"userId\"=$2", sel,
	)
...
func (o *TeamMember) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	...
	if !cached {
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(teamMemberPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert team_members, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert team_members")
	}
...
func (o *TeamMember) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"team_members\" WHERE \"teamId\"=$1 AND \"userId\"=$2"
...
func TeamMemberExists(ctx context.Context, exec boil.ContextExecutor, teamId string, userId string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"team_members\" where \"teamId\"=$1 AND \"userId\"=$2 limit 1)"
