...
func testTeamMembersExists(t *testing.T) {
	...
	e, err := TeamMemberExists(ctx, tx, o.TeamId, o.UserId)
	if err != nil {
...
func testTeamMembersFind(t *testing.T) {
	...
	teamMemberFound, err := FindTeamMember(ctx, tx, o.TeamId, o.UserId)
	if err != nil {
		t.Error(err)
	}
...
func testTeamMemberToOneTeamUsingTeamIdTeam(t *testing.T) {
	...
	AddTeamHook(boil.AfterSelectHook, func(ctx context.Context, e boil.ContextExecutor, o *Team) error {
...
func testTeamMemberToOneUserUsingUserIdUser(t *testing.T) {
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := TeamMemberSlice{&local}
	if err = local.L.LoadUserIdUser(ctx, tx, false, (*[]*TeamMember)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testTeamMemberToOneSetOpTeamUsingTeamIdTeam(t *testing.T) {
	...
	for i, x := range []*Team{&b, &c} {
		...
		if exists, err := TeamMemberExists(ctx, tx, a.TeamId, a.UserId); err != nil {
			t.Fatal(err)
		} else if !exists {
...
func testTeamMemberToOneSetOpUserUsingUserIdUser(t *testing.T) {
	var err error
...
var (
	teamMemberDBTypes = map[string]string{`TeamId`: `character varying`, `UserId`: `character varying`, `Role`: `character varying`}
	_                 = bytes.MinRead
)
