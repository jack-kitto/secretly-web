...
var EnvironmentTableColumns = struct {
	...
	TenantId:  "environments.tenantId",
...
var EnvironmentWhere = struct {
	...
	Name:      whereHelpernull_String{field: "\"environments\".\"name\""},
	TenantId:  whereHelperstring{field: "\"environments\".\"tenantId\""},
	CreatedAt: whereHelpernull_Time{field: "\"environments\".\"createdAt\""},
	UpdatedAt: whereHelpernull_Time{field: "\"environments\".\"updatedAt\""},
}
...
func (r *environmentR) GetTenantIdTenant() *Tenant {
	if r == nil {
		return nil
	}
...
var (
	environmentAllColumns            = []string{"id", "name", "tenantId", "createdAt", "updatedAt"}
	environmentColumnsWithoutDefault = []string{"id", "tenantId"}
	environmentColumnsWithDefault    = []string{"name", "createdAt", "updatedAt"}
...
func (o *Environment) TenantIdTenant(mods ...qm.QueryMod) tenantQuery {
...
func (environmentL) LoadTenantIdTenant(ctx context.Context, e boil.ContextExecutor, singular bool, maybeEnvironment interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		foreign.R.TenantIdEnvironments = append(foreign.R.TenantIdEnvironments, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.TenantId == foreign.ID {
				...
				foreign.R.TenantIdEnvironments = append(foreign.R.TenantIdEnvironments, local)
				break
			}
		}
	}
...
// SetTenantIdTenant of the environment to the related item.
// Sets o.R.TenantIdTenant to related.
// Adds o to related.R.TenantIdEnvironments.
func (o *Environment) SetTenantIdTenant(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Tenant) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &tenantR{
			TenantIdEnvironments: EnvironmentSlice{o},
		}
	} else {
		related.R.TenantIdEnvironments = append(related.R.TenantIdEnvironments, o)
	}
