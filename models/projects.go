...
var ProjectWhere = struct {
	...
	TenantId:  whereHelperstring{field: "\"projects\".\"tenantId\""},
	CreatedAt: whereHelpernull_Time{field: "\"projects\".\"createdAt\""},
	UpdatedAt: whereHelpernull_Time{field: "\"projects\".\"updatedAt\""},
}
...
func (r *projectR) GetTenantIdTenant() *Tenant {
	if r == nil {
		return nil
	}
...
var (
	projectAllColumns            = []string{"id", "name", "tenantId", "createdAt", "updatedAt"}
	projectColumnsWithoutDefault = []string{"id", "tenantId"}
	projectColumnsWithDefault    = []string{"name", "createdAt", "updatedAt"}
...
func (o *Project) TenantIdTenant(mods ...qm.QueryMod) tenantQuery {
...
func (projectL) LoadTenantIdTenant(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProject interface{}, mods queries.Applicator) error {
	var slice []*Project
	var object *Project
	...
	if singular {
		...
		foreign.R.TenantIdProjects = append(foreign.R.TenantIdProjects, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.TenantId == foreign.ID {
				...
				foreign.R.TenantIdProjects = append(foreign.R.TenantIdProjects, local)
				break
			}
		}
	}
...
// SetTenantIdTenant of the project to the related item.
// Sets o.R.TenantIdTenant to related.
// Adds o to related.R.TenantIdProjects.
func (o *Project) SetTenantIdTenant(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Tenant) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &tenantR{
			TenantIdProjects: ProjectSlice{o},
		}
	} else {
		related.R.TenantIdProjects = append(related.R.TenantIdProjects, o)
	}
