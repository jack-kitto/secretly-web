...
var APIKeyWhere = struct {
	...
	UserId:    whereHelpernull_String{field: "\"api_keys\".\"userId\""},
	Key:       whereHelpernull_String{field: "\"api_keys\".\"key\""},
	Name:      whereHelpernull_String{field: "\"api_keys\".\"name\""},
	ExpiresAt: whereHelpernull_Time{field: "\"api_keys\".\"expiresAt\""},
	TenantId:  whereHelperstring{field: "\"api_keys\".\"tenantId\""},
	CreatedAt: whereHelpernull_Time{field: "\"api_keys\".\"createdAt\""},
	UpdatedAt: whereHelpernull_Time{field: "\"api_keys\".\"updatedAt\""},
}
...
func (r *apiKeyR) GetTenantIdTenant() *Tenant {
	if r == nil {
		return nil
	}
...
func (r *apiKeyR) GetUserIdUser() *User {
	if r == nil {
		return nil
	}
	return r.UserIdUser
...
var (
	apiKeyAllColumns            = []string{"id", "userId", "key", "name", "expiresAt", "tenantId", "createdAt", "updatedAt"}
	apiKeyColumnsWithoutDefault = []string{"id", "tenantId"}
	apiKeyColumnsWithDefault    = []string{"userId", "key", "name", "expiresAt", "createdAt", "updatedAt"}
...
func (o *APIKey) TenantIdTenant(mods ...qm.QueryMod) tenantQuery {
...
func (o *APIKey) UserIdUser(mods ...qm.QueryMod) userQuery {
	queryMods := []qm.QueryMod{
...
func (apiKeyL) LoadTenantIdTenant(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAPIKey interface{}, mods queries.Applicator) error {
	var slice []*APIKey
	var object *APIKey
	...
	if singular {
		...
		foreign.R.TenantIdAPIKeys = append(foreign.R.TenantIdAPIKeys, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.TenantId == foreign.ID {
				...
				foreign.R.TenantIdAPIKeys = append(foreign.R.TenantIdAPIKeys, local)
				break
			}
		}
	}
...
// loaded structs of the objects. This is for an N-1 relationship.
func (apiKeyL) LoadUserIdUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAPIKey interface{}, mods queries.Applicator) error {
	var slice []*APIKey
	var object *APIKey
	...
	if singular {
		...
		foreign.R.UserIdAPIKeys = append(foreign.R.UserIdAPIKeys, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.UserId, foreign.ID) {
				...
				foreign.R.UserIdAPIKeys = append(foreign.R.UserIdAPIKeys, local)
				break
			}
		}
	}
...
// SetTenantIdTenant of the apiKey to the related item.
// Sets o.R.TenantIdTenant to related.
// Adds o to related.R.TenantIdAPIKeys.
func (o *APIKey) SetTenantIdTenant(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Tenant) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &tenantR{
			TenantIdAPIKeys: APIKeySlice{o},
		}
	} else {
		related.R.TenantIdAPIKeys = append(related.R.TenantIdAPIKeys, o)
	}

	return nil
}

// SetUserIdUser of the apiKey to the related item.
// Sets o.R.UserIdUser to related.
// Adds o to related.R.UserIdAPIKeys.
func (o *APIKey) SetUserIdUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	if related.R == nil {
		related.R = &userR{
			UserIdAPIKeys: APIKeySlice{o},
		}
	} else {
		related.R.UserIdAPIKeys = append(related.R.UserIdAPIKeys, o)
	}
...
func (o *APIKey) RemoveUserIdUser(ctx context.Context, exec boil.ContextExecutor, related *User) error {
	var err error
	...
	for i, ri := range related.R.UserIdAPIKeys {
		if queries.Equal(o.UserId, ri.UserId) {
			continue
		}

		ln := len(related.R.UserIdAPIKeys)
		if ln > 1 && i < ln-1 {
			related.R.UserIdAPIKeys[i] = related.R.UserIdAPIKeys[ln-1]
		}
		related.R.UserIdAPIKeys = related.R.UserIdAPIKeys[:ln-1]
		break
	}
	return nil
}
