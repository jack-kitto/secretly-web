...
var SessionWhere = struct {
	...
	ExpiresAt: whereHelpernull_Time{field: "\"sessions\".\"expiresAt\""},
	CreatedAt: whereHelpernull_Time{field: "\"sessions\".\"createdAt\""},
}
...
var (
	sessionAllColumns            = []string{"id", "userId", "token", "expiresAt", "createdAt"}
	sessionColumnsWithoutDefault = []string{"id", "userId"}
	sessionColumnsWithDefault    = []string{"token", "expiresAt", "createdAt"}
